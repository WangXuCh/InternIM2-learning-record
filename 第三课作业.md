...
- 首先进入[飞书开放平台](https://open.feishu.cn/app?lang=zh-CN)，创建企业自建应用
  ...
  ![image-20240412085328209](C:\Users\ASUS\Desktop\internlm\img\image-20240412085328209.png)

- 点击添加一个机器人

  ![image-20240412085349900](C:\Users\ASUS\Desktop\internlm\img\image-20240412085349900.png)

- 复制基础信息-凭证与基础信息tab下，应用凭证中 App ID和App Secret，填入到 Integrate With Lark 的表单中

  ![image-20240412085449887](C:\Users\ASUS\Desktop\internlm\img\image-20240412085449887.png)

  ![image-20240412085523325](C:\Users\ASUS\Desktop\internlm\img\image-20240412085523325.png)

- 复制茴香豆Web中你的知识库下，Integrate With Lark 中提供的加密策略，填入到开发配置-事件与回调tab下的加密策略，注意两项都需要填入

  ![image-20240412085620160](C:\Users\ASUS\Desktop\internlm\img\image-20240412085620160.png)

  ![image-20240412085651036](C:\Users\ASUS\Desktop\internlm\img\image-20240412085651036.png)

- 复制茴香豆Web中你的知识库下，Integrate With Lark 中提供的事件回调地址，填入到开发配置-事件与回调tab下的事件配置，选择默认的【将事件发送至开发者服务器】即可，点击保存后若修改成功，则表示鉴权成功。

  ![image-20240412085727089](C:\Users\ASUS\Desktop\internlm\img\image-20240412085727089.png)

  ![image-20240412085746328](C:\Users\ASUS\Desktop\internlm\img\image-20240412085746328.png)

- 订阅事件：继续点击当前页面的【添加事件】按钮，搜索【接收消息】事件，并申请开通对应权限

  ![image-20240412085834481](C:\Users\ASUS\Desktop\internlm\img\image-20240412085834481.png)

- 权限配置：点击开发配置-权限管理tab下，申请开通权限：im:chat:readonly 和 im:message:send_as_bot

  ![image-20240412085915860](C:\Users\ASUS\Desktop\internlm\img\image-20240412085915860.png)
...
![image-20240412084630564](C:\Users\ASUS\Desktop\internlm\img\image-20240412084630564.png)

可以看出没有修改群名后缀的时候机器人并不能对问题做出反应。

![image-20240412085100781](C:\Users\ASUS\Desktop\internlm\img\image-20240412085100781.png)
